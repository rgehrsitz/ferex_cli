...
type TSPInfo struct {
	CurrentBalance      float64 `yaml:"current_balance" validate:"required,gte=0"`
	...
	WithdrawalStrategy  string  `yaml:"withdrawal_strategy" validate:"required,oneof=fixed_amount life_expectancy lump_sum"`
